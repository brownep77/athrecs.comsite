...
Checked through 21 September 2026 for the catalogue horizon ending 31 December 2027.

## Published coverage

- Published 64 officially verified series after moving one permit-conflicted race back to research: 53 half-marathon editions and 14 ten-mile editions across England, Scotland, Wales, Northern Ireland and Ireland.
...
## 20 September 2026 scan

The approved Life Style Sports Dundalk Half Marathon & 10K on 31 January 2027 was already represented by its canonical multi-distance card, but only its 10K edition was exposed. The card now publishes the verified half-marathon as its primary distance while retaining both distances, with the official 10:20 half start, €44.50 entry and direct Eventmaster checkout.

Central Lancashire New Year Half Marathon on 10 January 2027 remains on its existing canonical card and now uses the live event-specific SiEntries checkout and current official source instead of its older booking route.

## 21 September 2026 scan

Rugeley Runners' official EntryCentral page opened registration for the Rugeley 10 Mile Road Race on 14 February 2027. The new canonical card records the 10:00 start, Redbrook Hayes School race headquarters, £24 affiliated entry price and direct event-specific checkout.
