...
BEGIN
 ...
 IF b.status<>'ready' OR b.payload_hash<>'19b32727196acd520f149ce6245dbb51bdc9d5b11472aacd5e8d3df865a0f15b' OR b.validation_summary->>'invalidRows'<>'0' THEN RAISE EXCEPTION 'Only this validated ready batch may publish'; END IF;
 ...
 END LOOP;
 summary_value:=jsonb_build_object('eventsUpserted',75,'newEvents',44,'editionsUpserted',146,'entryOptionsUpserted',0,'revisionId',rev);
