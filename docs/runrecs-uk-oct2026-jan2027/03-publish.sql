...
BEGIN
 ...
 IF b.status<>'ready' OR b.payload_hash<>'929cc3cfbefab6f8784e5cde874e71d783fa0a57cb43821f0f373aa4f1822a3d' OR b.validation_summary->>'invalidRows'<>'0' THEN RAISE EXCEPTION 'Only this validated ready batch may publish'; END IF;
 ...
 END LOOP;
 summary_value:=jsonb_build_object('eventsUpserted',75,'newEvents',47,'editionsUpserted',152,'entryOptionsUpserted',0,'revisionId',rev);
