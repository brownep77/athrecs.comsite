...
BEGIN
 ...
 IF b.status<>'ready' OR b.payload_hash<>'706c4e0549df89a42c2b052b6736a17e05abbb6b3b395d24e1015d5952c8366f' OR b.validation_summary->>'invalidRows'<>'0' THEN RAISE EXCEPTION 'Only this validated ready batch may publish'; END IF;
 ...
 END LOOP;
 summary_value:=jsonb_build_object('eventsUpserted',3,'newEvents',0,'editionsUpserted',4,'entryOptionsUpserted',0,'revisionId',rev);
