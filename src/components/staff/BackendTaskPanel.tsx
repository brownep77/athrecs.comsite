...
const backendTasks = [
  ...
  { title: "Review result-to-athlete links", group: "Athletes & results", path: "/admin/result-links", description: "Open the result-linking review tool to investigate which athlete a result belongs to.", keywords: "matching duplicate reconcile identity evidence" },
