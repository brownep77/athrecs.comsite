...
import {
  runrecsGapFillUkEditions,
  runrecsGapFillUkSeries,
} from "./runrecs-gap-fill-2026-09-uk";
import {
  runrecsGapFillMoreEditions,
  runrecsGapFillMoreSeries,
} from "./runrecs-gap-fill-2026-09-more";
import {
  runrecsGapFillCEditions,
  runrecsGapFillCSeries,
} from "./runrecs-gap-fill-2026-09-c";
import {
  runrecsGapFillDEditions,
  runrecsGapFillDSeries,
} from "./runrecs-gap-fill-2026-09-d";
import {
  runrecsGapFillEEditions,
  runrecsGapFillESeries,
} from "./runrecs-gap-fill-2026-09-e";
import {
  runrecsGapFillFEditions,
  runrecsGapFillFSeries,
} from "./runrecs-gap-fill-2026-09-f";
import {
  runrecsGapFillGEditions,
  runrecsGapFillGSeries,
} from "./runrecs-gap-fill-2026-09-g";
import {
  runrecsGapFillOctEditions,
  runrecsGapFillOctSeries,
} from "./runrecs-gap-fill-2026-10";
import {
  runrecsGapFillOctBEditions,
  runrecsGapFillOctBSeries,
} from "./runrecs-gap-fill-2026-10-b";
import {
  runrecsGapFillOctCEditions,
  runrecsGapFillOctCSeries,
} from "./runrecs-gap-fill-2026-10-c";
import {
...
import {
  runrecsGapFillOctFEditions,
  runrecsGapFillOctFSeries,
} from "./runrecs-gap-fill-2026-10-f";
import {
  runrecsGapFillOctGEditions,
  runrecsGapFillOctGSeries,
} from "./runrecs-gap-fill-2026-10-g";
import {
  runrecsGapFillOctHEditions,
  runrecsGapFillOctHSeries,
} from "./runrecs-gap-fill-2026-10-h";
import {
  runrecsGapFillOctIEditions,
  runrecsGapFillOctISeries,
} from "./runrecs-gap-fill-2026-10-i";
import {
  runrecsGapFillOctJEditions,
  runrecsGapFillOctJSeries,
} from "./runrecs-gap-fill-2026-10-j";
import {
  runrecsGapFillOctKEditions,
  runrecsGapFillOctKSeries,
} from "./runrecs-gap-fill-2026-10-k";
import {
  runrecsGapFillOctLEditions,
  runrecsGapFillOctLSeries,
} from "./runrecs-gap-fill-2026-10-l";
import {
  runrecsGapFillOctMEditions,
  runrecsGapFillOctMSeries,
} from "./runrecs-gap-fill-2026-10-m";
import {
  runrecsGapFillOctNEditions,
  runrecsGapFillOctNSeries,
} from "./runrecs-gap-fill-2026-10-n";
import {
  runrecsGapFillOctOEditions,
  runrecsGapFillOctOSeries,
} from "./runrecs-gap-fill-2026-10-o";
import {
  runrecsGapFillNovBEditions,
  runrecsGapFillNovBSeries,
} from "./runrecs-gap-fill-2026-11-b";
import {
  runrecsGapFillDecDzEditions,
  runrecsGapFillDecDzSeries,
} from "./runrecs-gap-fill-2026-12-dz";
import {
  runrecsGapFillMar27DzEditions,
  runrecsGapFillMar27DzSeries,
} from "./runrecs-gap-fill-2027-03-dz";
import {
  runrecsGapFillAndorraEditions,
  runrecsGapFillAndorraSeries,
} from "./runrecs-gap-fill-andorra-2026-27";
import {
  runrecsGapFillAngolaQ4Editions,
  runrecsGapFillAngolaQ4Series,
} from "./runrecs-gap-fill-angola-2026-q4";
import {
  runrecsGapFillAngolaSepEditions,
  runrecsGapFillAngolaSepSeries,
} from "./runrecs-gap-fill-angola-2026-sep";
import {
  runrecsGapFillAngolaYearEditions,
  runrecsGapFillAngolaYearSeries,
} from "./runrecs-gap-fill-angola-2026-year";
import {
  runrecsGapFillAntiguaQ4Editions,
  runrecsGapFillAntiguaQ4Series,
} from "./runrecs-gap-fill-antigua-2026-q4";
import {
  runrecsGapFillAntiguaQ1Editions,
  runrecsGapFillAntiguaQ1Series,
} from "./runrecs-gap-fill-antigua-2027-q1";
import {
  runrecsGapFillAntiguaH1Editions,
  runrecsGapFillAntiguaH1Series,
} from "./runrecs-gap-fill-antigua-2027-h1";
...
for (const series of [
  ...
  ...(runrecsGapFillUkSeries as Series[]),
  ...(runrecsGapFillMoreSeries as Series[]),
  ...(runrecsGapFillCSeries as Series[]),
  ...(runrecsGapFillDSeries as Series[]),
  ...(runrecsGapFillESeries as Series[]),
  ...(runrecsGapFillFSeries as Series[]),
  ...(runrecsGapFillGSeries as Series[]),
  ...(runrecsGapFillOctSeries as Series[]),
  ...
  ...(runrecsGapFillOctFSeries as Series[]),
  ...(runrecsGapFillOctGSeries as Series[]),
  ...(runrecsGapFillOctHSeries as Series[]),
  ...(runrecsGapFillOctISeries as Series[]),
  ...(runrecsGapFillOctJSeries as Series[]),
  ...(runrecsGapFillOctKSeries as Series[]),
  ...(runrecsGapFillOctLSeries as Series[]),
  ...(runrecsGapFillOctMSeries as Series[]),
  ...(runrecsGapFillOctNSeries as Series[]),
  ...(runrecsGapFillOctOSeries as Series[]),
  ...(runrecsGapFillNovBSeries as Series[]),
  ...(runrecsGapFillDecDzSeries as Series[]),
  ...(runrecsGapFillMar27DzSeries as Series[]),
  ...(runrecsGapFillAndorraSeries as Series[]),
  ...(runrecsGapFillAngolaQ4Series as Series[]),
  ...(runrecsGapFillAngolaSepSeries as Series[]),
  ...(runrecsGapFillAngolaYearSeries as Series[]),
  ...(runrecsGapFillAntiguaQ4Series as Series[]),
  ...(runrecsGapFillAntiguaQ1Series as Series[]),
  ...(runrecsGapFillAntiguaH1Series as Series[]),
...
const mergedEditions = [
  ...
  ...(runrecsGapFillUkEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillMoreEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillCEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillDEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillEEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillFEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillGEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...
  ...(runrecsGapFillOctFEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctGEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctHEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctIEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctJEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctKEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctLEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctMEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctNEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillOctOEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillNovBEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillDecDzEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillMar27DzEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAndorraEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAngolaQ4Editions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAngolaSepEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAngolaYearEditions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAntiguaQ4Editions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAntiguaQ1Editions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
  ...(runrecsGapFillAntiguaH1Editions as Edition[]).filter((edition) => usedSlugs.has(edition.seriesSlug)),
