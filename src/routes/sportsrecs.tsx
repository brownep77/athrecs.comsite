...
// @ts-expect-error Generated route types are refreshed during the Vite build.
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "SportsRecs, RunRecs, ATHRECS, CycRecs, SwimRecs, TriRecs, GymRecs, FitRecs, sports events, results, athlete profiles",
      },
...
const principles = [
  ...
  },
  {
    ...
    description:
      "The network is being designed around one connected identity and shared data platform, while every sport keeps its own specialist experience.",
  },
];
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-[#070b18] text-white">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-10">
        ...
        <main id="top">
          <section className="grid min-h-[680px] items-center gap-14 py-20 lg:grid-cols-[1.08fr_0.92fr] lg:py-28">
            <div>
              ...
              <h1 className="mt-7 max-w-4xl text-balance text-5xl font-black leading-[0.96] tracking-[-0.055em] sm:text-6xl lg:text-7xl xl:text-[5.4rem]">
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                ...
                >
                  Visit the live ATHRECS platform
                  <ArrowUpRight className="size-4" aria-hidden="true" />
                </a>
              </div>
              ...
              <div className="relative overflow-hidden rounded-[2rem] border border-white/12 bg-white/[0.055] p-5 shadow-2xl shadow-black/30 backdrop-blur-xl sm:p-7">
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-2">
                  {networkSites.slice(0, 6).map((site) => (
                    <div
                      key={site.name}
                      className="rounded-2xl border border-white/10 bg-black/15 p-4 transition hover:border-white/20 hover:bg-white/[0.06]"
                    >
                      <div className="flex items-start justify-between gap-4">
                        <span className={cn("grid size-9 place-items-center rounded-xl border", site.accent)}>
                          <site.icon className="size-4.5" aria-hidden="true" />
                        </span>
                        <span
                          className={cn(
                ...
                <div className="mt-5 rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-4">
                  ...
                  <p className="mt-1 text-sm leading-6 text-cyan-50/70">
                    Each sport gets the language, filters and community it deserves, while the
                    network is designed to keep athlete identity and data connected.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="vision" className="scroll-mt-24 border-t border-white/10 py-20 sm:py-24">
            <div className="grid gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
              <div className="lg:sticky lg:top-10">
                ...
                <p className="mt-5 text-lg leading-8 text-slate-300">
                  Professional sport receives enormous attention. SportsRecs is being built to make
                  competition information and achievement easier to discover for everyone — elite,
                  club, local, age-group and recreational athletes alike.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                {principles.map((principle, index) => (
                  <article
                    key={principle.title}
                    className="group rounded-3xl border border-white/10 bg-white/[0.045] p-6 transition hover:border-cyan-300/25 hover:bg-cyan-300/[0.06] sm:p-7"
                  >
                    <div className="flex gap-5">
                      <span className="grid size-11 shrink-0 place-items-center rounded-2xl border border-white/10 bg-white/5 text-cyan-200 transition group-hover:border-cyan-300/25 group-hover:bg-cyan-300/10">
          ...
          <section className="border-t border-white/10 py-20 sm:py-24">
            <div className="relative overflow-hidden rounded-[2rem] border border-cyan-300/20 bg-gradient-to-br from-cyan-300/12 via-white/[0.045] to-lime-300/10 px-6 py-12 text-center shadow-2xl shadow-black/20 sm:px-12 sm:py-16">
              ...
              <div className="relative mx-auto max-w-3xl">
                ...
                <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                  ...
                  platforms. For now, explore ATHRECS and follow the network as the next sites are
                  prepared.
                </p>
                <a
                  href="https://www.athrecs.com"
...
function NetworkCard({ site }: { site: NetworkSite }) {
  ...
  if (site.href) {
    return (
      <a
        href={site.href}
        className="group rounded-3xl border border-white/10 bg-white/[0.045] p-6 text-white no-underline transition hover:-translate-y-1 hover:border-cyan-300/35 hover:bg-cyan-300/[0.07] hover:shadow-2xl hover:shadow-cyan-950/20"
