...
function BrandLogo({ compact = false }: { compact?: boolean }) {
  return (
    <span
      className={cn(
        "inline-flex items-baseline whitespace-nowrap font-display font-semibold tracking-tight text-fg",
...
function BrandLink({
  ...
  return localized ? (
    <Link
      ...
      className={className}
      aria-label="RunRecs.com country home"
    >
      {content}
    </Link>
  ) : (
    <Link to="/" className={className} aria-label="RunRecs.com home">
      {content}
    </Link>
  );
}
