  ...
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#f4f7f7" },
      {
        name: "keywords",
        content:
          "running races, marathon calendar, parkrun, 5K, 10K, half marathon, marathon, ultra marathon, trail running, race results, running clubs, RunRecs",
      },
      ...siteGraphMeta({
        title: `${SITE_NAME} — Running races, results and athletes`,
