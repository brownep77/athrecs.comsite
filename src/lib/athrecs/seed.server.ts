...
const SEED_VERSION = "athrecs-full-catalogue-v29";
...
async function seed(): Promise<void> {
  ...
  // Canonical tables are rebuilt from one complete in-repository snapshot.
  // The seed marker is written only after every relationship and count verifies.
